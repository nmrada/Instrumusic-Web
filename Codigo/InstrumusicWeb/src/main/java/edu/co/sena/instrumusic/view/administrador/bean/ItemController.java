...
import edu.co.sena.instrumusic.controller.administrador.beans.ItemFacade;
...
public class ItemController implements Serializable {
    ...
    @EJB
    private edu.co.sena.instrumusic.controller.administrador.beans.ItemFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setItemPK(new edu.co.sena.instrumusic.model.entities.ItemPK());
    }
    ...
    public Item getItem(edu.co.sena.instrumusic.model.entities.ItemPK id) {
    ...
    public static class ItemControllerConverter implements Converter {
        ...
        edu.co.sena.instrumusic.model.entities.ItemPK getKey(String value) {
            edu.co.sena.instrumusic.model.entities.ItemPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.instrumusic.model.entities.ItemPK();
            key.setProductoidProducto(values[0]);
            key.setPedidoFacturaidFactura(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(edu.co.sena.instrumusic.model.entities.ItemPK value) {
